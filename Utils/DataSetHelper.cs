...
namespace CommonUtils
{
    ...
    public class DataSetHelper
    {
        ...
        private bool RowEqual(DataRow rowA, DataRow rowB, DataColumnCollection columns)
        {
            ...
            {
                result &= ColumnEqual(rowA[columns[i].ColumnName.Trim()], rowB[columns[i].ColumnName.Trim()]);
            }
            return result;
        }
        ...
        private object Add(object a, object b)
        {
            ...
            decimal a0 = Convert.ToDecimal(a);
            decimal b0 = Convert.ToDecimal(b);
            return a0+b0;
        }
        ...
        public DataTable SelectDistinct(string tableName, DataTable sourceTable, string[] fieldNames)
        {
            ...
            {
                dt.Columns.Add(fieldNames[i], sourceTable.Columns[fieldNames[i].Trim()].DataType);
                fields += fieldNames[i] + ",";
            }
